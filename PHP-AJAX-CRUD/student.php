...
<body>
            ...
            <div class="modal-content">
                ...
                <form id="saveStudent">
                    <div class="modal-body">
                        ...
                        <div id="errorMessage" class="alert alert_warning d-none">
            ...
            <div class="modal-content">
                ...
                <form id="updateStudent">
                    <div class="modal-body">
                        ...
                        <div id="errorMessageUpdate" class="alert alert_warning d-none"></div>
    ...
    <div class="modal fade" id="studentViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Vies Student </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4> PHP CRUD using jquery ajax without page reload
                    ...
                    <div class="card-body">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                require 'dbcon.php';
                                $query = "SELECT * FROM student_ajax";
    ...
    <script>
        ...
        //CODE AJXA ==> DELETE DATA
        $(document).on('click', '.deleteStudentBtn', function(e) {
            e.preventDefault();
            if (confirm('Are you suer you want to delete this data?')) {
                var student_id = $(this).val();
                $.ajax({
                    type: "POST",
                    url: "code.php",
